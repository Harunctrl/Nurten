...
<body>
    ...
    <script>
        function moveYesButton() {
            ...
            // Mobil ve masaüstü için farklı hareket alanları
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Mobil ve masaüstü için farklı event'ler
            ...
            noBtn.addEventListener('click', showEmoji);
        });

        // Pencere boyutu değiştiğinde buton pozisyonlarını sıfırla
